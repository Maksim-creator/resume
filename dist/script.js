...
/* harmony import */ var _modules_toggleBtn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/toggleBtn */ "./src/js/modules/toggleBtn.js");



window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])('.nav_btn', '.overlay');
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_toggleBtn__WEBPACK_IMPORTED_MODULE_2__["default"])('.l');
});
...
var modal = function modal(triggerSelector, modalSelector) {
...
var toggleBtn = function toggleBtn(trigger) {
  var checkbox = document.querySelector(trigger);
  checkbox.addEventListener('click', function (e) {
    ...
    if (checkbox.checked) {
      ...
      var _arr = themeLink.getAttribute('href').toString().split('/');

      _arr[_arr.length - 1] = 'day.css';
      _arr = _arr.join('/');
      themeLink.setAttribute('href', _arr);
    }
  });
};
